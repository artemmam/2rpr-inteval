...
def exact_eval(u1, u2, l1, l2, d, p=10):
    """
    Check the cell u with classical Krawczyk operator if it is inside of the workspace area,
    outside or on the border
    :param u1: the X coordinates of cell u
...
def exact_krav_eval(u1, u2, l1, l2, d, p=10):
    """
    Check the cell u with classical Krawczyk operator if it is inside of the workspace area,
    outside or on the border
    :param u1: the X coordinates of cell u
    ...
    for k in range(p):
        v1mid = v1.mid()
        v2mid = v2.mid()
        v_exact = krav_func_opt(u1, u2, v1, v2, v1mid, v2mid, d) # Calculate exact_inclusion for u1, u2
        #rec_func_alt(u1, u2, v1, v2, v1mid, v2mid, d)
        #print("\nExact krav inclusion, k = ", k, ":")
        #print("v1 = ", v1)
        #print("v2 = ", v2)
        #print("u1 = ", u1)
        #print("u2 = ", u2)
